...
**Highway Gourmet Road**는 장거리 운전자들을 위한 웹 기반 여정 정보 큐레이션 시스템입니다.
출발지와 목적지를 입력하면 **최적의 이동 경로**를 제시하고, 경로 상의 **휴게소 위치**와 **맛집 정보**를 **직관적인 지도 UI**로 제공합니다. 사용자는 여행 중 휴식할 위치를 미리 파악하고, 편의시설을 확인하며 맛있는 음식을 발견할 수 있습니다.
